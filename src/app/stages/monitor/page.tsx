...
const features = [
  {
    title: 'Catch the Anomalies Other Tools Miss',
    description: 'Detect silent failures, misconfigured sensors, and abnormal log gaps that typically evade traditional monitoring solutions.',
    image: '/images/cross-system-visibility.png',
    imageAlt: 'Anomaly Detection Dashboard',
    imagePosition: 'right',
  },
  {
    title: 'Contextual Monitoring with Multimodal AI',
    description: 'Go beyond log analysis — correlate behavior across Maximo, ServiceNow, Slack, and Salesforce for cross-system detection.',
    image: '/images/unified-timelines.png',
    imageAlt: 'Cross-System Monitoring',
    imagePosition: 'left',
  },
  {
    title: 'No-Code Rules, Powered by Natural Language',
    description: 'Set up monitoring logic with simple English prompts like: \'Alert me when login from new IP occurs 15 mins before a config change.\'',
    image: '/images/cross-platform-intelligence.png',
    imageAlt: 'Natural Language Rules',
    imagePosition: 'right',
  },
  {
    title: 'Visual Summaries of Monitoring Insights',
    description: 'Receive LLM-powered dashboards summarizing what changed, what didn\'t log, and what requires attention — daily.',
    image: '/images/multisource.png',
    imageAlt: 'Monitoring Insights Dashboard',
    imagePosition: 'left',
  },
];
...
const workflow = [
  {
    header: 'Observe',
    subtext: 'Stream real-time logs from Maximo and enterprise apps into a single view.',
    tags: ['Real-Time', 'Log Streaming'],
    icon: <Eye size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Detect',
    subtext: 'Use semantic AI to surface anomalies, underreported events, and out-of-pattern behavior.',
    tags: ['Anomaly Detection', 'Pattern Analysis'],
    icon: <Activity size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Summarize',
    subtext: 'Daily insights help your team understand and prioritize abnormal signals.',
    tags: ['Daily Insights', 'Prioritization'],
    icon: <FileText size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Route',
    subtext: 'Automatically route issues to the proper response team or workflow.',
    tags: ['Smart Routing', 'Workflow Integration'],
    ...
    <>
      <main className="min-h-screen bg-black">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-xl md:text-2xl text-gray-400 mb-6 leading-relaxed">
                  Stay Ahead of Anomalies, Always
                </p>
                <p className="text-lg text-gray-400 mb-12 leading-relaxed">
                  Continuously observe enterprise systems using multimodal AI to detect abnormal behaviors, silent failures, and emerging threats — before they escalate.
                </p>
        ...
        <section className="bg-black py-20">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-gray-400 mb-8">
              Most monitoring tools miss subtle shifts or gaps in telemetry. Data Trei uses LLMs to spot unusual silence, delayed log activity, or emerging patterns in Maximo and related systems — offering contextual understanding instead of noise.
            </p>
          </div>
        </section>
        ...
        <section className="py-[180px] relative" style={{ backgroundColor: '#0B0E0E' }}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                How Monitor Works Across Your Stack
              </h2>
              <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                Data Trei's Monitor module transforms raw telemetry into actionable insights through a four-stage process designed for modern security teams.
              </p>
            </div>
        ...
        <section className="bg-black py-24">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Let Monitoring Become Your Superpower
            </h2>
            <p className="text-lg text-gray-400 mb-12">
              Don't just collect logs — understand what they mean. With Monitor, every moment is a chance to detect what others overlook.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/signup" className="inline-flex items-center px-8 py-4 text-base font-medium text-white bg-emerald-600 hover:bg-emerald-500 rounded-md transition-colors">
                Join Waitlist
