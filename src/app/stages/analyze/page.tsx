...
const features = [
  {
    title: 'Summarize What Happened — and Why',
    description: 'Auto-generate plain-language explanations of anomalous behaviors across your environment.',
    image: '/images/cross-system-visibility.png',
    imageAlt: 'AI Event Summarization',
    imagePosition: 'right',
  },
  {
    title: 'Score Behavior in Context',
    description: 'Understand the risk of user and system behavior using pattern history, frequency deviation, and semantic matching.',
    image: '/images/unified-timelines.png',
    imageAlt: 'Behavioral Risk Scoring',
    imagePosition: 'left',
  },
  {
    title: 'Correlate Across Systems',
    description: 'Reveal cause-and-effect relationships from Maximo to Salesforce to Slack — across time and system boundaries.',
    image: '/images/cross-platform-intelligence.png',
    imageAlt: 'Cross-System Correlation',
    imagePosition: 'right',
  },
  {
    title: 'Explain Threats Like an Analyst',
    description: 'Receive LLM-driven breakdowns of threat progression, recommended next steps, and executive summaries.',
    image: '/images/multisource.png',
    imageAlt: 'AI Threat Analysis',
    imagePosition: 'left',
  },
];
...
const workflow = [
  {
    header: 'Interpret',
    subtext: 'LLMs summarize complex logs into human-readable events.',
    tags: ['Log Analysis', 'Natural Language'],
    icon: <Brain size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Score',
    subtext: 'Assign behavioral and anomaly scores for each system entity.',
    tags: ['Risk Scoring', 'Pattern Analysis'],
    icon: <BarChart size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Correlate',
    subtext: 'Link related events and signals across systems.',
    tags: ['Cross-Platform', 'Event Linking'],
    icon: <Network size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Explain',
    subtext: 'Generate contextual briefings for SOCs and leadership.',
    tags: ['Executive Summaries', 'Action Items'],
    ...
    <>
      <main className="min-h-screen bg-black">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-xl md:text-2xl text-gray-400 mb-6 leading-relaxed">
                  AI-Powered Understanding at the Speed of Security
                </p>
                <p className="text-lg text-gray-400 mb-12 leading-relaxed">
                  Analyze turns system noise into strategic clarity. Data Trei's semantic engine interprets millions of logs, relationships, and anomalies to generate the summaries, correlations, and insights your team needs — instantly.
                </p>
        ...
        <section className="bg-black py-20">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-gray-400 mb-8">
              Security teams are flooded with fragmented logs and disconnected signals. Analyze unifies your data into a living model of your environment — surfacing what matters and suppressing what doesn't.
            </p>
          </div>
        </section>
        ...
        <section className="py-[180px] relative" style={{ backgroundColor: '#0B0E0E' }}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Built for Analysts, Engineers, and Executives
              </h2>
              <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                Data Trei's Analyze module transforms raw data into actionable intelligence through a four-stage process designed for modern security teams.
              </p>
            </div>
        ...
        <section className="bg-black py-24">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Understand Threats Like Never Before
            </h2>
            <p className="text-lg text-gray-400 mb-12">
              With Data Trei Analyze, your team spends less time digging through logs — and more time acting on what matters.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/signup" className="inline-flex items-center px-8 py-4 text-base font-medium text-white bg-emerald-600 hover:bg-emerald-500 rounded-md transition-colors">
                Join Waitlist
