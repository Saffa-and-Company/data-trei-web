        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-medium mb-8 text-white">
              Eliminate Operational Blind Spots in Maximo Environments
            </h1>
            <p className="text-xl md:text-2xl text-gray-400 mb-12 leading-relaxed">
              Stop threats from hiding in plain sight. Data Trei uses multimodal AI to surface hidden risks across your asset, maintenance, and log data—so you can see, understand, and act before disruption occurs.
            </p>
