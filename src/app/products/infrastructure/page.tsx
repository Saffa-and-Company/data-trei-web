...
const features = [
  {
    title: 'Enable Hardened Security Controls',
    description: 'Toggle industry-grade hardening policies for Maximo and connected enterprise software. Enforce stricter access, anomaly thresholds, and audit retention windows.',
    image: '/images/compliance-threats.png',
    imageAlt: 'Hardened Security Controls',
    imagePosition: 'right',
  },
  {
    title: 'Generate Audit-Ready Reporting',
    description: 'From patch compliance to operator activity — auto-generate weekly summaries that align with standards like NERC-CIP, ISO/IEC 27001, and more.',
    image: '/images/compliance-reports.png',
    imageAlt: 'Audit-Ready Reporting',
    imagePosition: 'left',
  },
  {
    title: 'Segment Views for Regulated Teams',
    description: 'Apply role-based filters so that compliance officers, security teams, and ops personnel get only what they need — with zero noise.',
    image: '/images/compliance-gaps.png',
    imageAlt: 'Segmented Team Views',
    imagePosition: 'right',
  },
  {
    title: 'Embed Infrastructure Context in Every Alert',
    description: 'Surface asset classifications, facility zones, and criticality ratings alongside security events. Prioritize faster with full situational awareness.',
    image: '/images/audit-logs.png',
    imageAlt: 'Infrastructure Context',
    imagePosition: 'left',
  },
];
...
const workflow = [
  {
    header: 'Harden',
    subtext: 'Lock down your Maximo and integrated platforms with stricter anomaly and access thresholds.',
    tags: ['Access Control', 'Security Policies'],
    icon: <Lock size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Monitor',
    subtext: 'Continuously scan for compliance drift and misconfiguration.',
    tags: ['Compliance Scanning', 'Drift Detection'],
    icon: <Search size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Report',
    subtext: 'Send summaries to regulators, leadership, or internal teams.',
    tags: ['Audit Reports', 'Compliance Docs'],
    icon: <ClipboardCheck size={32} className="text-[#3EE8B5] mb-4" />,
  },
  {
    header: 'Respond',
    subtext: 'Get prioritized resolution paths designed for field ops and control room teams.',
    tags: ['Resolution Paths', 'Field Operations'],
    icon: <Wrench size={32} className="text-[#3EE8B5] mb-4" />,
  },
];
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-xl md:text-2xl text-gray-400 mb-6 leading-relaxed">
                  Built for Mission-Critical Systems. Hardened by Design.
                </p>
                <p className="text-lg text-gray-400 mb-12 leading-relaxed">
                  Designed for industries where failure is not an option. The Critical Infrastructure Add-On includes hardened security controls, enhanced audit capabilities, and compliance-grade filters to meet the demands of regulated environments.
                </p>
            ...
            <div className="rounded-xl overflow-hidden border border-gray-800 bg-[#0A0A0A] shadow-2xl">
              <div className="p-4 border-b border-gray-800">
                <div className="font-mono text-sm text-emerald-400">
                  SHOW compliance status for critical infrastructure assets
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                <div className="rounded-lg bg-gray-900 p-4">
                  <div className="text-emerald-400 font-semibold mb-2">🛡️ Compliance Status</div>
                  <div className="space-y-2">
                    <div className="p-2 bg-gray-800 rounded">NERC-CIP Controls: 98% Compliant</div>
                    <div className="p-2 bg-gray-800 rounded">ISO 27001 Controls: 95% Compliant</div>
                    <div className="p-2 bg-gray-800 rounded">Audit Logs: Retention Policy Active</div>
                  </div>
                </div>
                <div className="relative aspect-video">
                  <div className="rounded-lg overflow-hidden border border-gray-800 bg-[#0A0A0A] h-full">
                    <div className="p-3 border-b border-gray-800">
                      <div className="text-lg font-semibold text-white">Infrastructure Dashboard</div>
                    </div>
                    <div className="p-4 bg-[#0B1512]">
                      <div className="space-y-3">
                        <div className="flex items-center gap-2 p-3 rounded-lg bg-[#0A1F16]">
                          ...
                          <span className="text-emerald-400 font-mono">All Systems Secured</span>
                        </div>
                        <div className="flex items-center gap-2 p-3 rounded-lg bg-[#0A1F16]">
                          <svg className="w-5 h-5 text-emerald-500" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          ...
                          <div className="flex items-center gap-2">
                            <span className="px-2 py-1 rounded bg-[#0A1F16] text-emerald-400">Protected</span>
                            <span className="text-emerald-400">Critical Assets</span>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <section className="bg-black py-20">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Meet the Add-On That Fortifies Maximo Environments
            </h2>
            <p className="text-lg text-gray-400 mb-8">
              Industrial environments need more than alerts. They need resilience, traceability, and control. This add-on augments the Data Trei platform with layers of protection and reporting built specifically for critical infrastructure operators.
            </p>
          </div>
        </section>
        ...
        <section className="py-[180px] relative" style={{ backgroundColor: '#0B0E0E' }}>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-16">
              Security That Understands Industrial Realities
            </h2>
